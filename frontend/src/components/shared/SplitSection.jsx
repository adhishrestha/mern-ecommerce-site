...
const SplitSection = ({
  ...
  return (
    <section>
      <Container>
        <div
          className={`flex flex-col overflow-hidden bg-[#f5f5f5] lg:flex-row`}
        >
          {/* CONTENT */}
          <div
            className={`flex min-w-0 flex-1 items-center justify-center py-14 ${mobileContentFirst ? 'order-1' : 'order-2'} ${reverse ? 'lg:order-2' : 'lg:order-1'} `}
          >
